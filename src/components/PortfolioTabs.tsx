        ...
        {activeTab === "Digital Marketing" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 pt-8">
                {marketingProjects.map((project) => (
                    <div key={project.title} className="relative w-full nb-card bg-background border-[3px] md:border-[4px] border-foreground shadow-[6px_6px_0px_var(--foreground)] p-5 md:p-8 space-y-6 group overflow-visible h-full flex flex-col justify-between">
                        {/* Floating Badge */}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-1 text-center md:text-left">
                                ...
                                <div className="flex items-center justify-center md:justify-start">
                                    <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tighter text-primary leading-none uppercase">
                                        {project.results}
                                    </h2>
                                </div>
                            </div>
